...
type ModelVariant = { id: string; model: string; revision: string; precision: string; providerOnly: string[] | null; transport: 'gateway' | 'openai-compatible'; supportsTools: boolean };
