...
import { LiveVoiceControls } from '../../src/components/voice/LiveVoiceControls';
...
function Preview() {
  ...
  return <main className="min-h-screen bg-slate-950 p-6 text-white">
    ...
    <div className="grid gap-6 lg:grid-cols-2"><section className="rounded-2xl border border-white/10 p-5">
      ...
      <LiveVoiceControls agentId={null} busy={false} messages={[]} onSubmit={setDraft} />
      <details><summary className="mb-3 text-xs">Optional recording workflow</summary><RoutedVoiceControls agentId={null} busy={false} messages={[]} onSubmit={setDraft} onTranscript={setDraft} onCaptureState={setCapturing} /></details>
